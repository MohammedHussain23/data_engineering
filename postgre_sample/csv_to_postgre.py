...
print("Raw data (with duplicates) loaded into table: test_schema.sample_people_raw")
...
print("Cleaned data (duplicates removed) written to table: test_schema.sample_people_cleaned")
